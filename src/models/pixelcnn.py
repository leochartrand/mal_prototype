"""
This is an implementation of the conditional Gated PixelCNN model used in:
...
PixelCNN implementation adapted from:
    1.  Oord, A.V., Kalchbrenner, N., Espeholt, L., Kavukcuoglu, K., Vinyals, O., & Graves, A. (2016). Conditional Image Generation with PixelCNN Decoders. ArXiv, abs/1606.05328.
        https://arxiv.org/abs/1606.05328

Source: https://github.com/anair13/rlkit/blob/master/rlkit/torch/vae/initial_state_pixelcnn.py
"""
...
def weights_init(m):
    ...
    try:
        ...
        print("Skipping initialization of ", classname, "Error:", e)
